    ...
    <div className="container">
      ...
      <Image
            ...
            <ul className={styles.socialList}>
                <li><a href="https://www.facebook.com/paulthesage" target="_blank"><FontAwesomeIcon icon={faFacebook} size="2x"></FontAwesomeIcon></a></li>
                <li><a href="https://www.linkedin.com/in/gwinyai-nyatsoka-4a026037/" target="_blank"><FontAwesomeIcon icon={faLinkedin} size="2x"></FontAwesomeIcon></a></li>
                <li><a href="https://github.com/Gwinyai" target="_blank"><FontAwesomeIcon icon={faGithub} size="2x"></FontAwesomeIcon></a></li>
                <li><a href="https://medium.com/@gwinyai" target="_blank"><FontAwesomeIcon icon={faMedium} size="2x"></FontAwesomeIcon></a></li>
            </ul>
